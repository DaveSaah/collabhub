...
class _ProjectListingsScreenState extends State<ProjectListingsScreen> { 
  ...
  List<Map<String, dynamic>> projects = [
    {
      'title': 'Project Alpha',
      'description': 'An AI-powered chatbot for customer support with natural language processing capabilities.',
      'collaborators': ['Alex Kim', 'Jamie Chen', 'Taylor Wong']
    },
    {
      'title': 'HealthTech App',
      'description': 'A mobile app for healthcare solutions that connects patients with doctors and provides medication reminders.',
      'collaborators': ['Morgan Lee', 'Casey Johnson', 'Jordan Smith']
    },
    {
      'title': 'Open Source CMS',
      'description': 'A community-driven content management system platform built with modern web technologies.',
      'collaborators': ['Riley Parker', 'Quinn Adams', 'Sam Rivera']
    },
    {
      'title': 'Blockchain Voting',
      'description': 'A decentralized voting system that ensures transparency and security in electoral processes.',
      'collaborators': ['Avery Thomas', 'Blake Martinez', 'Cameron Rodriguez']
    },
    {
      'title': 'E-commerce Platform',
      'description': 'An online marketplace for small businesses with integrated payment systems and inventory management.',
                                ...
                                children: [
                                  ...
                                  Wrap(
                                    ...
                                    children: List.generate(
                                      project['collaborators'].length > 3 ? 3 : project['collaborators'].length,
                                      (i) => Chip(
                                        label: Text(project['collaborators'][i]),
